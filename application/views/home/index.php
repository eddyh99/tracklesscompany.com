        ...
        <div class="row gx-5 align-items-center">
            <div class="col-12 col-lg-6">
                ...
                <div class="mb-5 mb-lg-0 text-center text-lg-start">
                    ...
                    <p class="text-tracklesscompany mb-5 f-inter">
                        TracklessCompany offers clients the opportunity to open an offshore company. The opening of an
                        offshore company, in countries with legislation that favours this type of incorporation, allows
                        to exploit the most the tax advantage, with low, zero or flat taxation, offered by local laws in
                        favour of offshore companies.
                    </p>
                    <h1 class="text-slider-tracklesscompany mb-3 f-poppins">What is an Offshore Company?</h1>
                    <p class="text-tracklesscompany mb-5 f-inter">An Offshore Company is defined as an entity that has
                        established its
                        registered office in a
                        different country than that in which it carries out its main business.
                        Offshore companies, in addition to tax advantages, enjoy full capital protection, absolute
                ...
                <div class="company-country text-center">
                    ...
                    <div class="row d-flex justify-content-center align-items-center flex-column">
                        <div class="col-12 col-sm-6 col-lg-4 my-3">
                            ...
                            <p class="f-poppins text-start mt-2">High level of corporate and monetary
                                privacy. FLAT TAX </p>
                        </div>
                    </div>
                </div>
