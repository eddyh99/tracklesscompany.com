        ...
        <div class="row d-flex align-items-center justify-items-center min-hight company-indonesia">
            <div class="col-lg-12">
                ...
                <div class="mb-5 mb-lg-0 text-center">
                    <h1 class="text-slider-indo mb-3 f-poppins">WELCOME TO INDONESIA</h1>
                </div>
                <div class="row d-flex justify-content-center align-items-center flex-column">
                    <div class="col-4 my-3">
                        ...
                        <p class="f-poppins text-start mt-2">Maximum level of corporate and monetary
                            privacy. LOW FLAT TAX</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="indonesia-country text-center">
                    <h1 class="my-5 f-poppins">
                        ...
                        What makes Indonesia a great place for company formation ?
                    </h1>
                </div>
                <div class="text-center content-indonesia">
                    <h2 class="f-poppins">Indonesia</h2>
                    <p class="f-inter my-5">Indonesia, in addition to an absolutely strategic geographical position,
                        offers
                        absolute privacy
                        to all members of the companies. Indonesia is not a tax heaven and is not part of any black or
                        grey list. It is simply a country that does not have bilateral agreements with any other country
                        and, therefore, any request for data relating to shareholders, administrators or directors of
                        companies based in Indonesia, are rejected.</p>
                </div>
                <div class="row d-flex">
                    <div class="col-4">
                        <div class="p-2">
                            <div
                                class="box-price px-4 mb-5 text-center py-5 f-poppins d-flex align-items-center flex-column mb-3">
                                <div class="type-price bronze py-3 px-5">
                                    Bronze
                                </div>
                                <div class="box-list my-3">
                                    <span>PMA Incorporation and registration</span>
                                    <h3>Idr. 50.000.000 (Una Tantum)</h3>
                                </div>
                                <div class="box-list my-3">
                                ...
                                <div class="box-list my-3">
                                    <span>Virtual Office (Optional)</span>
                                    <h3>Idr. 10.000.000 (Yearly)</h3>
                                </div>
                                <a class="btn-order py-3 px-5 mt-auto" href="">SELECT</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="p-2">
                            <div
                                class="box-price px-4 mb-5 text-center py-5 f-poppins d-flex align-items-center flex-column mb-3">
                                <div class="type-price silver py-3 px-5">
                                    Silver
                                </div>
                                <div class="box-list my-3">
                                    <span>PMA Incorporation and registration</span>
                                ...
                                <div class="box-list my-3">
                                    <span>Servizio di contabilita`e report</span>
                                    <h3>Idr. 10.000.000 (Yearly)</h3>
                                </div>
                                <div class="box-list my-3">
                                    <span>Flat tax</span>
                                    <h3>Idr. 5.500.000 (Yearly)</h3>
                                </div>
                                <a class="btn-order py-3 px-5 mt-auto" href="">SELECT</a>
                            </div>
                        </div>
                    ...
                    <div class="col-4">
                        <div class="p-2">
                            <div
                                class="box-price px-4 mb-5 text-center py-5 f-poppins d-flex align-items-center flex-column mb-3">
                                <div class="type-price gold py-3 px-5">
                                    Gold
                                </div>
                                <div class="box-list my-3">
                                    <span>PMA Incorporation and registration</span>
                                ...
                                <div class="box-list my-3">
                                    <span>Kitas 1</span>
                                    <h3>Idr. 17.000.000 (Valid 2 Years)</h3>
                                </div>
                                <div class="box-list my-3">
                                    <span>Kitas 2</span>
                                    <h3>Idr. 17.000.000 (Valid 2 Years)</h3>
                                ...
                                <div class="box-list my-3">
                                    <span>additional kitas</span>
                                    <h3>Idr.17.000.000 (Each – Valid 2 Years)</h3>
                                </div>
                                <a class="btn-order py-3 px-5 mt-auto" href="">SELECT</a>
                            </div>
                        </div>
                    ...
                    <div class="col-12 text-end">
                        <p class="text-white">Renew Kitas after 2 years : IDR 15.000.000 ( valid for 2 years )</p>
                    </div>
                </div>
            </div>
        </div>
...
<footer class="bg-footer-trackless py-3">
    <div class="container-fluid px-md-5">
        <div class="container">
            ...
            <div class="d-flex justify-content-around">
                ...
                <div class="col-4 footer-contact">
                    <h2>Contact us</h2>
                    <span>
                        <a href="mailto:tracklesscompany@tracklessmail.com" class="text-decoration-none">
                            tracklesscompany@tracklessmail.com
                        </a>
                    </span>
                </div>
            </div>
        ...
        <div class="d-flex flex-wrap justify-content-end footer-menus" translate="no">
            ...
            <a href="https://tracklesscompany.com" class="active">TracklessCompany</a> |
